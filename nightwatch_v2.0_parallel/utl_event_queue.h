#ifndef UTL_TIME_EVENT_QUEUE_H_
#define UTL_TIME_EVENT_QUEUE_H_
...
void add_time_event(struct timeval *time, 
                    time_event_handler handler, 
                    void *private);
void add_time_event_when_pending(struct timeval *time, 
                                 time_event_handler handler, 
                                 void *private);
void remove_time_event(void *private); 
void remove_time_event_when_pending(void *private); 

#endif /* UTL_TIME_EVENT_QUEUE_H_ */
